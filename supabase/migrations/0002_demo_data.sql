-- ============================================================
-- معين maaoun.com — بيانات العرض التجريبية لـ Supabase
-- ============================================================
...
values (
  ...
  '966500000000',
  'https://maaoun.com',
  'معين منصة متكاملة لإنشاء متاجر إلكترونية للعملاء: أنشئ، صمّم، جهّز المنتجات، اضبط SEO، وسلّم المتجر على نطاق فرعي خاص — ثم يدير العميل متجره بنفسه من لوحة تحكم مستقلة.',
  'متجرك الإلكتروني…',
