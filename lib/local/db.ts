...
function seedIfEmpty(db: DatabaseSync): void {
  ...
  db.prepare(`INSERT INTO site_settings
    ...
    "966500000000",
    "https://maaoun.com",
    "معون منصة لبناء المواقع والمتاجر الإلكترونية للعملاء: نصمّم الموقع، نجهّز المنتجات والصفحات، نضبط أساسيات SEO، ثم نسلّم المشروع جاهزًا للإدارة.",
    "معون لبناء المواقع والمتاجر الإلكترونية",
    "نحوّل فكرتك إلى موقع أو متجر إلكتروني احترافي يعكس هوية تجارتك ويسهّل وصول عملائك إلى منتجاتك وخدماتك.",
    JSON.stringify([
